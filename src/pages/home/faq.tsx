...
export function FAQSection() {
  return (
    <section className="w-full py-16 px-4 md:px-8 lg:px-16 bg-pink-400" id="faq">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mt-12 text-center space-y-6">
          ...
          <Button
            ...
            asChild
          >
            <a href='https://wa.me/5515997475220?text=Olá%2C+tenho+interesse+em+saber+mais+sobre+o+produto'>
              FALE CONOSCO
            </a>
          </Button>
        </div>
