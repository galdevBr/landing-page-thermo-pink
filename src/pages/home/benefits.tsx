...
export function Benefits() {
  const benefitsList = [
    ...
    { title: 'FÓRMULA AVANÇADA PARA PERFORMANCE', description: 'Combinamos ingredientes como taurina, cafeína e carnitina para impulsionar sua energia e disposição ao longo do dia.', icon: <img src={ShirtIcon} alt="Shirt" className="w-12 h-12" /> },
...
{/* TODO: Aumentar espacamento superior */}
