...
export function ContactSection() {
  ...
  return (
    ...
    <section className="relative w-full py-16 px-4 md:px-8 lg:px-16 space-y-16">
      <div className="absolute bottom-[50px] left-[-600px] w-[900px] h-[900px] md:w-[1200px] md:h-[1200px] bg-pink-500 opacity-15 rounded-full filter blur-[100px] z-0 overflow-hidden" />
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-40 mt-12 mx-auto justify-center text-center md:text-start">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href='https://wa.me/5515997475220/?text=Olá%2C+tenho+interesse+em+saber+mais+sobre+o+produto' className="hover:text-pink-500" target="_blank" rel="noopener noreferrer">
                  Fale conosco
                </a>
              </li>
              {/* <li>
